...
export interface UserOut { id: string; name: string; email?: string | null; phone?: string | null; role: UserRole; warehouse?: WarehouseCode | null; is_active: boolean; created_at: string; }
